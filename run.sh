...
do
    ...
    do
        ...
        python train_experimental_branch3.py \
            --source_path /mnt/c/Users/Aooooo/Documents/DATA/large_angle/blockA_fusion_small_aerial+somestreet/train \
            --test_path /mnt/c/Users/Aooooo/Documents/DATA/large_angle/blockA_fusion_small_aerial+somestreet/test \
            --model_path outputs/matrixcity/experimental_branch3_${init_type}_${nn_type}_${bound_type}_${eps}_${min_samples}_${depth_l1_weight_init}_${depth_l1_weight_final}_${minmax}_${range_scale}_${partial_scaling}_${sigma_scaling}_${noise_method}_${random_view_num}_${nn_start_iter}_${nn_derivatives_iter}_${nn_update_interval} \
            --images ${images} \
            --depths ${depths} \
            --resolution -1 \
            --init_type ${init_type} \
