...
CUDA_VISIBLE_DEVICES=3 python train_experimental_branch3.py \
    ...
    --model_path outputs/mcmc/bdaibdai___MatrixCity/small_city/blockA_fusion_small_aerial+somestreet/experimental_branch3_${init_type}_${nn_type}_${bound_type}_partial${partial_scaling}_${eps}_${min_samples}_${depth_l1_weight_init}_${depth_l1_weight_final}_separate_ \
    --images ${images} \
    --resolution -1 \
    --init_type ${init_type} \
    --cap_max ${cap_max} \
