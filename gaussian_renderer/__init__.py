...
def render_noise(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, separate_sh = False, override_color = None, use_trained_exp=False, noise=None, noise_mask=None):
    """
    Render the scene. 
