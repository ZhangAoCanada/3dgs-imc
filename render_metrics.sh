...
#             depth_l1_weight_init=0.3
#         fi
#         for model_path in ${model_path_base}/${scene_name}/${model_path_ext}*${test_selection}*
#         do
#             if [ -d "$model_path" ]; then
#                 echo "Processing model_path: $model_path"
#                 python render.py \
...
#                 python metrics.py \
#                     --model_path ${model_path} \
#                     --metrics_save_path ${model_path_base}/metrics/${model_path_ext}/${scene_name}_${test_selection}_metrics.csv
#             fi
#         done
#     done
# done
...
#             echo "[*****rendering*****] rendering with noise_method=${noise_method}"
#             python render.py \
#                 --source_path ${source_path} \
#                 --test_selection_path ${test_selection_path} \
#                 --model_path ${model_path} \
...
model_path_base=/data1/zhangao/outputs/develop3_discontinuous2
model_path_ext=develop3
