...
do
    ...
    CUDA_VISIBLE_DEVICES=1 python train_experimental_branch2_singleview.py \
        ...
        --model_path outputs/mcmc/bdaibdai___MatrixCity/small_city/blockA_fusion_small_aerial+somestreet/experimental_branch2_${init_type}_fixnum_singleview_aligned_partial${partial_scaling}_sized_boundxyz \
        --images ${images} \
        --resolution -1 \
        --init_type ${init_type} \
        --cap_max ${cap_max} \
