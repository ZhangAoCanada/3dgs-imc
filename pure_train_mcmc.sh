...
CUDA_VISIBLE_DEVICES=3 python train.py \
    ...
    --model_path outputs/mcmc/bdaibdai___MatrixCity/small_city/blockA_fusion_small_aerial+somestreet/new3dgs_exposure_sfm_${cap_max}_${noise_lr}_scale${scale_reg}_opacity0.01_densification-${densify_from_iter}-${densification_interval}-antialiasing \
    --images ${images} \
    --resolution -1 \
    --init_type ${init_type} \
    --cap_max ${cap_max} \
